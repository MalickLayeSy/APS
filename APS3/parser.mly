...
%%
  ...
  def:
    ...
    | FUN IDENT type LBRACKET args RBRACKET bloc      {FunPDef ($2,$3,$5,$7)}
    | FUN REC IDENT type LBRACKET args RBRACKET bloc  {FunRecPDef ($3,$4,$6,$8)}
    | FUN IDENT type LBRACKET args RBRACKET sexpr     {FunDef ($2,$3,$5,$7)}
    | FUN REC IDENT type LBRACKET args RBRACKET sexpr {FunRecDef ($3,$4,$6,$8)}
    | VAR IDENT stype                                 {VarDef($2,$3)}
    | PROC IDENT LBRACKET argsp RBRACKET bloc         {ProcDef($2,$4,$6)}
    | PROC REC IDENT LBRACKET argsp RBRACKET bloc     {ProcRecDef($3,$5,$7)}
  ;
